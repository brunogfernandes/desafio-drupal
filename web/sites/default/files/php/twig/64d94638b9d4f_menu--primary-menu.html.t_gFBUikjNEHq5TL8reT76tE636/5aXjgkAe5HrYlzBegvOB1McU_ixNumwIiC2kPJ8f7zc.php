...
class __TwigTemplate_591c835514400674e0595c692c46dceb extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["is_top_level_menu"] ?? null) && twig_get_attribute($this->env, $this->source, $context["item"], "below", [], "any", false, false, true, 129))) ? ("primary-nav-submenu-toggle-button") : (false))]), "html", null, true);
  ...
  ";
    ...
    {
        return new Source("", "core/themes/olivero/templates/navigation/menu--primary-menu.html.twig", "/home/bruno/Projetos/drupal/web/core/themes/olivero/templates/navigation/menu--primary-menu.html.twig");
    }
